...
import '../../Data/data_sources/remote/HomeTabDataSource.dart' as _i655;
import '../../Data/data_sources/remote/Impl/auth_remote_daraSource_impl.dart'
    as _i920;
import '../../Data/data_sources/remote/Impl/HomeTabDataSourceImpl.dart'
    as _i771;
...
import '../../Data/repositories/HomeRepository.dart' as _i234;
import '../../Data/repositories/HomeRepositoryImpl.dart' as _i407;
...
import '../homescreen/tabs/home/Cubit/movie_view_model.dart' as _i327;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i655.HomeTabDataSource>(
      () => _i771.HomeTabDataSourceImpl(apiManger: gh<_i54.ApiManger>()),
    );
    ...
    gh.factory<_i234.HomeRepository>(
      () => _i407.HomeRepositoryImpl(
        homeTabDataSource: gh<_i655.HomeTabDataSource>(),
      ),
    );
    gh.factory<_i927.RegisterViewModel>(
      () => _i927.RegisterViewModel(authRepository: gh<_i648.AuthRepository>()),
    );
    gh.factory<_i327.MoviesCubit>(
      () => _i327.MoviesCubit(homeRepository: gh<_i234.HomeRepository>()),
    );
    return this;
  }
}
